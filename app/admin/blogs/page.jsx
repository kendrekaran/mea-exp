        ...
        <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
          ...
          <form onSubmit={handleAuth}>
            ...
            <button
              ...
              className="w-full bg-[#0A9DB2] text-white py-3 px-6 rounded-md hover:bg-[#1c6570] transition-colors disabled:bg-gray-400"
            >
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-white rounded-lg shadow p-8">
          ...
          <Link
            href="/admin/new-blog"
            className="px-6 py-3 bg-[#0A9DB2] text-white rounded-md hover:bg-[#1c6570] transition-colors inline-block"
          >
            Create New Blog
          </Link>
        </div>
                ...
                <tr key={blog.slug} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                    ...
                    <Link
                      ...
                      className="text-[#0A9DB2] hover:text-[#1c6570]"
                    >
                      Edit
                    </Link>
