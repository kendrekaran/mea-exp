    ...
    <div className="bg-gray-50 text-gray-600 min-h-screen  mt-[-80] md:mt-[-96] ">
      ...
      <div className="bg-gradient-to-r from-[#0A9DB2] to-[#0A9DB2] text-white py-12 md:px-24">
        <div className="container mx-auto px-4">
          <Link href="/blog" className="text-white hover:text-cyan-200 flex items-center mb-6 font-medium">
          ...
          {blog.createdAt && (
            <div className="mt-4 text-cyan-100">
      ...
      <div className="container mx-auto px-4 md:px-12 -mt-8">
        ...
        {/* Call to action */}
        <div className="bg-gradient-to-r from-cyan-50 to-cyan-50 rounded-lg border border-cyan-100 p-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div>
              <h3 className="text-2xl font-bold mb-2 text-gray-800">Ready to apostille your documents?</h3>
              <p className="text-gray-600 mb-6 md:mb-0">Contact MEA Expert today!</p>
            </div>
            <Link 
              href="/contact" 
              className="inline-block bg-[#0A9DB2] text-white font-semibold px-6 py-3 rounded-md hover:bg-[#1c6570] transition-colors shadow-md"
            >
              Contact Us Today
            </Link>
          </div>
