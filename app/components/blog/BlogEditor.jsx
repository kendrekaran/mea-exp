          ...
          <div className="flex justify-between items-center mb-4 sticky top-0 bg-white pb-2 border-b">
            ...
            <div className="flex space-x-2">
              <button 
                ...
                className="px-4 py-2 bg-[#0A9DB2] text-white rounded hover:bg-[#1c6570] transition-colors"
              >
                Save Changes
              </button>
              <button 
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-4">
          ...
          <button
            ...
            onClick={saveBlog}
            disabled={loading}
            className="px-4 py-2 bg-[#0A9DB2] text-white rounded hover:bg-[#1c6570] transition-colors disabled:bg-gray-400"
          >
              ...
              {blog.content.length === 0 ? (
                ...
                <div className="space-y-4">
                  {blog.content.map((block, index) => (
                    <div 
                      key={index} 
                      className={`border ${block.isTemplateStart ? 'border-[#0A9DB2]' : 'border-gray-200'} rounded-lg p-4 bg-white`}
                    >
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-medium text-gray-700 capitalize flex items-center">
                          {block.type} Block
                          {block.isTemplateStart && (
                            <span className="ml-2 px-2 py-0.5 bg-cyan-100 text-[#0A9DB2] text-xs rounded-full">
                              {block.templateName}
                            </span>
                          )}
                        </span>
                        <div className="flex space-x-2">
                          {block.isTemplateStart && (
                            <button
                              ...
                              className="p-1 text-[#0A9DB2] hover:bg-cyan-50 rounded"
                              title="Edit Template"
                            >
                              Edit Template
                            </button>
